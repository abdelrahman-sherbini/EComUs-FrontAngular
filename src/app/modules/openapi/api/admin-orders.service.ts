...
} from './admin-orders.serviceInterface';
...
export class AdminOrdersService extends BaseService implements AdminOrdersServiceInterface {
     ...
     */
    public getOrderById1(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<OrderDTO>;
    public getOrderById1(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<OrderDTO>>;
    public getOrderById1(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<OrderDTO>>;
    public getOrderById1(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateOrderStatus(id: number, orderStatusDTO: OrderStatusDTO, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<OrderDTO>;
    public updateOrderStatus(id: number, orderStatusDTO: OrderStatusDTO, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<OrderDTO>>;
    public updateOrderStatus(id: number, orderStatusDTO: OrderStatusDTO, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<OrderDTO>>;
    public updateOrderStatus(id: number, orderStatusDTO: OrderStatusDTO, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        if (orderStatusDTO === null || orderStatusDTO === undefined) {
            throw new Error('Required parameter orderStatusDTO was null or undefined when calling updateOrderStatus.');
        }
        ...
        let localVarPath = `/api/admin/orders/${this.configuration.encodeParam({name: "id", value: id, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}/update-status`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<OrderDTO>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: orderStatusDTO,
                responseType: <any>responseType_,
